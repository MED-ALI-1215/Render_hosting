...
def calculate_quality_metrics(generation, documents, question):
    ...
    try:
        ...
        if overall >= 0.9:
            metrics["quality"]["grade"] = f"{overall:.2f}, A"
        elif overall >= 0.8:
            metrics["quality"]["grade"] = f"{overall:.2f}, B"
        elif overall >= 0.7:
            metrics["quality"]["grade"] = f"{overall:.2f}, C"
        elif overall >= 0.6:
            metrics["quality"]["grade"] = f"{overall:.2f}, D"
        else:
            metrics["quality"]["grade"] = f"{overall:.2f}, F"
